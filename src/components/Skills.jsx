...
const Skills = () => {
  ...
  const frontendSkills = [
    ...
    { skill: 'Bootstrap 5.0', level: 80, color: 'bg-blue-500' },
  ...
  const toolsSkills = [
    ...
    { skill: 'Canva', level: 70, color: 'bg-pink-500' },
  ];
        ...
        >
          ...
          <div className="mt-10">
            ...
            <div className="flex flex-wrap gap-3">
              {['Java', 'Next.js', 'Python', 'Jest', 'GraphQL', 'Node.js', 'Express', 'MongoDB', 'RESTful APIs', 'Responsive Design', 'UI/UX', 'Performance Optimization'].map((skill) => (
                <span 
                  key={skill} 
