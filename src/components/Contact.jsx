            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-600 dark:text-gray-300">chandanabblr12@gmail.com</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-600 dark:text-gray-300">+91 90197221851</p>
                </div>
              </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <button 
                ...
                className="w-full px-6 py-2 text-white bg-indigo-600 rounded-lg hover:bg-indigo-700 focus:outline-none disabled:bg-indigo-400"
              >
