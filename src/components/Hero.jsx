    ...
    <section id="home" className="pt-32 pb-20 md:pt-40 md:pb-28">
      <div className="grid md:grid-cols-2 gap-8 items-center">
        <div>
          ...
          >
            Hi, I'm <span className="text-indigo-600">Chandana B</span>
          </h1>
          <p 
            ref={descriptionRef}
        ...
        >
          <div className="w-full h-64 md:h-96 bg-indigo-100 dark:bg-indigo-900/30 rounded-xl overflow-hidden relative">
            ...
            <img
  src="chandu.jpeg"  // Replace with the path to your JPEG image
  alt="Chandana.B"
  className="object-cover"  // Maintain the same size and responsiveness
/>
